...
public class Tree {
    ...
    // Question
    // Implement a method to return the ancestors of a value in a
    // List<Integer>.
...
class TestTree {
    public static void main(String[] args) {
        ...
        System.out.printf("is binary search tree: %s\n", tree.isBinarySearchTree());
        tree2.swapRoot();
        System.out.printf("is binary search tree: %s\n", tree2.isBinarySearchTree());
        System.out.printf("is binary search tree: %s\n", tree2.getNodesAtDistance(3));
